package com.shenruihai.encryption.sm2;
...
import com.shenruihai.encryption.sm3.SM3Digest;
import com.shenruihai.encryption.Util;
 ...
 * SM2
 * 非对称加密，基于ECC。
 * SM2(256位) 安全强度比RSA(2048位)高，但运算速度快于RSA
 * @author juihai
 * @date 2021/3/27
 */
